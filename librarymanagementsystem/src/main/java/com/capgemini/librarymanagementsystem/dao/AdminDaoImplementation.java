...
import com.capgemini.librarymanagementsystem.dto.BookIssueDetailsDto;
	...
	public boolean returnBook(int userId, int bookId) {
		...
		try {
			...
			Query q = manager.createQuery(
					"select b from BookIssueDetailsDto b where b.id = :id and b.bookIssueDetailsPrimaryKey.bookId = :bid");
			...
			if (i >= 1) {
				...
				if (i1 >= 1) {
					Query q3 = manager.createQuery(
							"delete from BookIssueDetailsDto b where b.bookIssueDetailsPrimaryKey.bookId = :bid and id =:id");
